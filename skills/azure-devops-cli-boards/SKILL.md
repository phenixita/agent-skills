...
description: Manage Azure Boards work items, areas, and iterations with the CLI.
---

# Azure DevOps CLI - Boards

Manage work items, area paths, and iterations using Azure Boards CLI commands.
